...
######
#jobsubmit -p basic -A circgp -m 370G -t 7-00:00:00 -c 20 -M ALL Rscript /autofs/vast/circ/mjk2/CXR_ED/SCRIPTS/3_BWH_prc_seq.R -1
######
...
which <- i_in[1]
file_code    <- "ML690_20210514_095408"
